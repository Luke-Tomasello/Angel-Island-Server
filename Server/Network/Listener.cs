 ...
 * CHANGELOG:
 *	7/3/22, Yoar
 *		Merge with RunUO 2.3. For some reason, the 4-parameter overload of 'Socket.BeginAccept'
 *		threw an error since the move to .net6. Using the 2-parameter overload seems the work.
 *	12/23/08, Adam
...
namespace Server.Network
{
    public class Listener : IDisposable
    {
        ...
        public Socket Socket { get { return m_Listener; } }
