...
namespace Server
{
    ...
    public class Sector
    {
        ...
        public void Deactivate()
        {
            if (Active)
            {
                if (m_Items != null)
                {
                    ...
                    List<Item> items = new List<Item>(m_Items);
                ...
                if (m_Mobiles != null)
                {
                    ...
                    List<Mobile> mobs = new List<Mobile>(m_Mobiles);
        ...
        public List<Region> Regions
        {
            ...
            {
                if (m_RegionRects == null)
                    return m_DefaultRectList.Select(e => e.Region).ToList();

                return m_RegionRects.Select(e => e.Region).ToList();
            }
        }
