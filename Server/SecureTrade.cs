...
namespace Server
{
    public class SecureTrade
    {
        ...
        public SecureTrade(Mobile from, Mobile to)
        {
            ...
            bool from6017 = (from.NetState == null ? false : from.NetState.ContainerGridLines/*IsPost6017*/);
            bool to6017 = (to.NetState == null ? false : to.NetState.ContainerGridLines/*IsPost6017*/);
