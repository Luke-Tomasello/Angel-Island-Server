...
namespace Server.Custom
{
    public class Categorization
    {
        ...
        {
            CommandSystem.Register("RebuildCategorization", AccessLevel.Owner, new CommandEventHandler(RebuildCategorization_OnCommand));
        }
        ...
        public static void RebuildCategorization_OnCommand(CommandEventArgs e)
        {
            ...
            Export(root, Path.Combine(Core.DataDirectory, "objects.xml"), "Objects");
        ...
        public static void Load()
        {
            ...
            m_RootItems = Load(types, Path.Combine(Core.DataDirectory, "items.cfg"));
            m_RootMobiles = Load(types, Path.Combine(Core.DataDirectory, "mobiles.cfg"));
        }
