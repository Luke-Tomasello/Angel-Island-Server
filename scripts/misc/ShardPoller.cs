 ...
 *	ChangeLog:
 *  7/24/06, Rhiannon
 *		Changed test in OnDoubleClick() to allow access by Administrators and Owners.
 *
 */
...
namespace Server.Misc
{
    ...
    public class ShardPollGump : Gump
    {
        ...
        public ShardPollGump(Mobile from, ShardPoller poller, bool editing, Queue polls)
            : base(50, 50)
        {
            m_From = from;
            m_Poller = poller;
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (info.ButtonID == 1)
            {
                ...
                if (switched < m_Poller.Options.Length)
