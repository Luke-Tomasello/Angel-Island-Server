 ...
 * CHANGELOG:
 *	2/24/07, Adam
 *      - Add in Keywords and Responses for wisps, and enable OnSpeach
 *      - Do not require wisps to be facing you to speak
 *      Old school wisps ftw
 *	3/16/07, Cyrun Ersaid
 *      -Edited tokenizer to parse on:
 *      -White Space, Comma, Period, Semi-Colon, Colon, Question Mark, Exclamation Marks, Brackets, Parenthesis, and Hyphons.
 */
...
namespace Server.Misc
{
    ...
    public class InhumanSpeech
    {
        ...
        public static InhumanSpeech Wisp
        {
            get
            {
                if (m_WispSpeech == null)
                {
                    ...
                    m_WispSpeech.Flags = IHSFlags.OnMovement | IHSFlags.OnSpeech;

                    m_WispSpeech.Keywords = new string[]
                        {
                            "silver", "gold", "gems", "kill", "killing", "slay",
                            "fought", "fight", "magic", "weapon", "spells", "spell",
                            "child", "woman", "man", "human", "monster", "monsters",
                            "food", "run", "escape", "away", "where", "find", "found",
                            "help", "dead", "die", "dying", "resurrect",
                            "losing", "life", "lives", "death", "ghost",
                            "ghosts", "british", "blackthorn", "guild",
                            "guilds", "dragon", "dragons", "game", "games",
                            "ultima", "adam", "jade", "love", "hate", "care",
                            "bring", "get", "take", "quest",
                            "me", "I", "we", "her", "him", "them", "us"
                        };

                    m_WispSpeech.Responses = new string[]
                        {
                            "silver", "gold", "gems", "kill", "killing", "slay",
                            "fought", "fight", "magic", "weapon", "spells", "spell",
                            "child", "woman", "man", "human", "monster", "monsters",
        ...
        public string[] Keywords
        {
            ...
            {
                m_Keywords = value;
                m_KeywordHash = new Hashtable(m_Keywords.Length, new myComparer());
        ...
        public bool OnSpeech(Mobile mob, Mobile speaker, string text)
        {
            ...
            // wisps do not need to be facing you
            if (mob.BodyValue != 58)
            {
            ...
            // Tokenizer - parses text for white space and other non-alphanumeric characters.
