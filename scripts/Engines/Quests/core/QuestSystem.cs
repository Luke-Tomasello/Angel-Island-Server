...
namespace Server.Engines.Quests
{
    ...
    public abstract class QuestSystem
    {
        ...
        public virtual void GetContextMenuEntries(ArrayList list)
        {
        ...
        public virtual void ClearQuest(bool completed)
        {
            ...
            if (m_From.Quest == this)
            {
                ...
                {
                    ArrayList doneQuests = m_From.DoneQuests;

                    if (doneQuests == null)
                        m_From.DoneQuests = doneQuests = new ArrayList();
                    ...
                    {
                        QuestRestartInfo restartInfo = (QuestRestartInfo)doneQuests[i];
        ...
        public static bool CanOfferQuest(Mobile check, Type questType, out bool inRestartPeriod)
        {
            ...
            ArrayList doneQuests = pm.DoneQuests;
