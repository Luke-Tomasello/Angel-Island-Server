                    ...
                    case 0x00E4: // *i wish to access the city treasury*
                        {
                            ...
                            {
                                NewGumps.FactionGumps.OpenFinanceGump(from, town);
                                return;
                            }
                    ...
                    case 0x0ED: // *i am sheriff*
                        {
                            ...
                            if (NewGumps.FactionGumps.Enabled)
                            {
                                NewGumps.FactionGumps.OpenSheriffGump(from, town);
                                return;
                            }
                    ...
                    case 0x00E9: // *what is my faction term status*
                        {
                            ...
                            {
#if RunUO
                                if (Faction.CheckLeaveTimer(pl))
                                    break;
#endif

                                TimeSpan remaining = (pl.LeaveBegin + FactionConfig.LeavePeriod) - DateTime.UtcNow;
