...
namespace Server.Factions
{
    ...
    public class FactionGuardAI : BaseAI
    {
        ...
        public override TimeSpan TimeUntilBandage
        {
            get
            {
        ...
        public override bool DequipWeapon()
        {
        ...
        public override bool UseItemByType(Type type)
        {
            Container pack = m_Guard.Backpack;
        ...
        public Mobile FindDispelTarget(bool activeOnly)
        {
            ...
            if (activeOnly)
            {
                ...
                {
                    AggressorInfo info = aggressed[i] as AggressorInfo;
                ...
                {
                    AggressorInfo info = aggressors[i] as AggressorInfo;
            ...
            if (m_Mobile.Spell == null && DateTime.UtcNow >= m_Mobile.NextSpellTime)
            {
                ...
                if (combatant != null)
                {
                    ...
                    if (spell == null && 2 > Utility.Random(100) && m_Guard.Mana >= (ManaReserve + 10))
                    {
                        ...
                        {
                            if ((Type)types[0] == typeof(StrengthSpell))
                                UseItemByType(typeof(BaseStrengthPotion));
                            else if ((Type)types[0] == typeof(AgilitySpell))
