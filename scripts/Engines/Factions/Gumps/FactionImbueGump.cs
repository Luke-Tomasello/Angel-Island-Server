...
namespace Server.Factions
{
    public class FactionImbueGump : FactionGump
    {
        ...
        private TextDefinition m_Notice;
        private int m_Quality;

        private FactionItemDefinition m_Definition;

        public FactionImbueGump(int quality, Item item, Mobile from, CraftSystem craftSystem, BaseTool tool, TextDefinition notice, int availableSilver, Faction faction, FactionItemDefinition def)
            : base(100, 200)
        {
            m_Item = item;
            m_Mobile = from;
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (m_Tool != null && !m_Tool.Deleted && m_Tool.UsesRemaining > 0)
                ...
                TextDefinition.SendMessageTo(m_Mobile, m_Notice);
        }
    }
}