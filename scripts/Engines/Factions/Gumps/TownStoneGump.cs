...
namespace Server.Factions
{
    public class TownStoneGump : FactionGump
    {
                ...
                case 1: // hire sheriff
                    {
                        ...
                        else
                        {
                            ...
                            m_From.BeginTarget(12, false, TargetFlags.None, new TargetStateCallback(HireSheriff_OnTarget), m_Town);
                        }
                ...
                case 2: // hire finance minister
                    {
                        ...
                        else
                        {
                            ...
                            m_From.BeginTarget(12, false, TargetFlags.None, new TargetStateCallback(HireFinanceMinister_OnTarget), m_Town);
                        }
        ...
        public static void HireSheriff_OnTarget(Mobile from, object obj, object state)
        {
            Town town = state as Town;

            if (town == null)
                return;

            Faction faction = town.Owner;

            if (town.Owner != faction || !faction.IsCommander(from))
            {
                from.SendLocalizedMessage(1010339); // You no longer control this city
            }
            else if (town.Sheriff != null)
            {
            ...
            else if (obj is Mobile)
            {
                ...
                else if (faction.Commander == targ)
                {
        ...
        public static void HireFinanceMinister_OnTarget(Mobile from, object obj, object state)
        {
            Town town = state as Town;
