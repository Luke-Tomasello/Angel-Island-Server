                ...
                case 1:
                    {
                        ...
                        AOS.Damage(to, to, Utility.RandomMinMax(10, 40), 0, 100, 0, 0, 0, this);
                ...
                case 2:
                    {
                        ...
                        AOS.Damage(to, to, Utility.RandomMinMax(10, 40), 100, 0, 0, 0, 0, this);
                ...
                default:
                    {
                        ...
                        AOS.Damage(to, to, Utility.RandomMinMax(10, 40), 0, 0, 0, 0, 100, this);
        ...
        protected override void GenerateTreasure()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                if (item is BaseWeapon)
                {
                    ...
                    {
                        // TODO: What level?
                        weapon.DamageLevel = Utility.RandomEnumValue<WeaponDamageLevel>();//(WeaponDamageLevel)Utility.Random(6);
                        weapon.AccuracyLevel = Utility.RandomEnumValue<WeaponAccuracyLevel>(); // (WeaponAccuracyLevel)Utility.Random(6);
                        weapon.DurabilityLevel = Utility.RandomEnumValue<WeaponDurabilityLevel>(); // (WeaponDurabilityLevel)Utility.Random(6);
                    }
                ...
                else if (item is BaseArmor)
                {
                    ...
                    {   // TODO: What level?
                        armor.ProtectionLevel = Utility.RandomEnumValue<ArmorProtectionLevel>();//(ArmorProtectionLevel)Utility.Random(6);
                        armor.DurabilityLevel = Utility.RandomEnumValue<ArmorDurabilityLevel>();//(ArmorDurabilityLevel)Utility.Random(6);
                    }
