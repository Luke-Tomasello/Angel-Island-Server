...
namespace Server.Items
{
    public class RaisableItem : Item
    {
        ...
        {
            RaisableItem new_raisable_item = new RaisableItem(this.ItemID);
            new_raisable_item.MaxElevation = MaxElevation;
            new_raisable_item.MoveSound = MoveSound;
            new_raisable_item.StopSound = StopSound;
            new_raisable_item.CloseDelay = CloseDelay;

            return base.Dupe(new_raisable_item, amount);
        }
