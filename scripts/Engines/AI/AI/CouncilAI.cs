...
/* Scripts/Engines/AI/AI/CouncilAI.cs
 * ChangeLog:
 *	1/1/09, Adam
 ...
 *	6/01/05 Kit
 *		Added use of mass dispel to dispel choices
    ...
    public class CouncilAI : BaseAI
    {
        ...
        public override bool DoActionCombat(MobileInfo info)
        {
            ...
            if (m_Mobile.Spell == null && DateTime.UtcNow > m_NextCastTime && m_Mobile.InRange(combatant, 12))
            {
                ...
                {
                    m_Mobile.DebugSay(DebugFlags.AI, "failed: spell != null && spell.Cast");
                }
            }
