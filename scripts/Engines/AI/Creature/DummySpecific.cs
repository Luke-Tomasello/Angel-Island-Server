 ...
 * CHANGELOG:
 *	1/21/05 - Pix
 *		Removed DummyTheif's shard-crashing ability.
 */
...
namespace Server.Mobiles
{
    ...
    public class DummyNox : Dummy
    {
        ...
        [Constructable]
        public DummyNox()
            : base(AIType.AI_Mage, FightMode.All | FightMode.Closest, 15, 1, 0.2, 0.6)
        {
    ...
    public class DummyHealer : Dummy
    {
        ...
        [Constructable]
        public DummyHealer()
            : base(AIType.AI_Healer, FightMode.All | FightMode.Closest, 15, 1, 0.2, 0.6)
        {
            // A Dummy Healer Mage
            int iHue = 20 + Team * 40;
            int jHue = 25 + Team * 40;
    ...
    public class DummyTheif : Dummy
    {
        ...
        //[Constructable]
        public DummyTheif()
            : base( /*AIType.AI_Thief*/ AIType.AI_Melee, FightMode.All | FightMode.Closest, 15, 1, 0.2, 0.6)
        {
        ...
        public DummyTheif(Serial serial)
            : base(serial)
        {
        }
