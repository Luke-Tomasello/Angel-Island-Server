    ...
    public class LargeBODGump : Gump
    {
            ...
            : base(25, 25)
        {
            ...
            if (deed.Material != BulkMaterialType.None)
                TextEntry.AddHtmlText(this, 75, y, 300, 20, BulkMaterialInfo.Lookup(deed.Material).RequireLabel, false, false, 0x7FFF, 0xFFFFFF); // All items must be made with x material.
