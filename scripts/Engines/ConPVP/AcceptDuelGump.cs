...
/* Scripts\Engines\ConPVP\AcceptDuelGump.cs
 * Changelog:
 *  3/14/22, Yoar
    ...
    public class AcceptDuelGump : Gump
    {
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (info.IsSwitched(1))
            {
                ...
                {
                    pm.SendMessage(0x22, "You have already signed up for a tournament.");
                    m_Challenger.SendMessage("{0} cannot fight because they are already signed up for a tournament.", pm.Name);
                }
                else
                {
                    bool added = false;
