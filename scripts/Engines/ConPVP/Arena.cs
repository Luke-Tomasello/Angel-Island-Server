    ...
    public class Arena : IComparable
    {
        ...
        public bool IsGuarded
        {
            ...
            set
            {
                ...
                if (m_Region != null)
                    m_Region.IsGuarded = m_IsGuarded;
            }
        }
        ...
        public Map Facet
        {
            ...
            set
            {
                ...
                if (m_Zone.Start != Point2D.Zero && m_Zone.End != Point2D.Zero && m_Facet != null)
                    m_Region = new SafeZone(m_Name, m_Zone, m_Outside, m_Facet, m_IsGuarded);
                else
                    m_Region = null;
            }
        }
        ...
        public SafeZone Region { get { return m_Region; } }
        ...
        public int Spectators
        {
            get
            {
                ...
                int specs = m_Region.Players.Count - m_Players.Count;
        ...
        public void MoveInside(DuelPlayer[] players, int index)
        {
            ...
            for (int i = 0; i < players.Length; ++i)
            {
                ...
                Point2D p = offsets[offset++ % offsets.Length];
        ...
        private static void Rotate(ref Point2D p, int[,] matrix)
        {
            p = new Point2D((p.X * matrix[0, 0]) + (p.Y * matrix[0, 1]), (p.X * matrix[1, 0]) + (p.Y * matrix[1, 1]));
        }
