    ...
    public sealed class HolySense : Power
    {
        public HolySense()
        {
            m_Definition = new PowerDefinition(
                    ...
                    "Searches within a short range for evils. The search range is proportional to your life force."
                );
        }
        ...
        {
            if (m.BeginAction(typeof(HolySense)))
            {
