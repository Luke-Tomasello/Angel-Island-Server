...
namespace Server.Engines.Craft
{
    ...
    {
        public static EnhanceResult Invoke(Mobile from, CraftSystem craftSystem, BaseTool tool, Item item, CraftResource resource, Type resType, ref TextDefinition resMessage)
        {
            if (item == null)
            ...
            if (!craftItem.CheckSkills(from, resType, craftSystem, tool, ref quality, ref allRequiredSkills, false))
