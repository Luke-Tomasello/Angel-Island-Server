...
/* Scripts/Gumps/CategorizedAddGump.cs
 * Changelog:
 *  6/5/04, Pix
...
namespace Server.Gumps
{
    ...
    public class CAGObject : CAGNode
    {
        ...
        public override void OnClick(Mobile from, int page)
        {
            ...
            {
                CommandSystem.Handle(from, string.Format("{0}Add {1}", CommandSystem.CommandPrefix, m_Type.Name));
    ...
    public class CAGCategory : CAGNode
    {
        ...
        public static CAGCategory Root
        {
            ...
            {
                if (m_Root == null)
                    m_Root = Load(Path.Combine(Core.DataDirectory, "objects.xml"));
