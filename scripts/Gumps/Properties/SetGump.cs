...
/* Scripts/Gumps/Properties/SetGump.cs
 * Changelog:
 *  11/17,06, Adam
 *      Add: #pragma warning disable 429
 *      The Unreachable code complaint in this file is acceptable
 *      C:\Program Files\RunUO\Scripts\Gumps\Properties\SetGump.cs(110,68): warning CS0429: Unreachable expression code detected
 *  6/5/04, Pix
    ...
    public class SetGump : Gump
    {
        ...
        private class InternalPicker : HuePicker
        {
            ...
            public override void OnResponse(int hue)
            {
                try
                {
                    Server.Commands.CommandLogging.LogChangeProperty(m_Mobile, m_Object, m_Property.Name, hue.ToString());
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (shouldSet)
            {
                try
                {
                    Server.Commands.CommandLogging.LogChangeProperty(m_Mobile, m_Object, m_Property.Name, toSet == null ? "(null)" : toSet.ToString());
