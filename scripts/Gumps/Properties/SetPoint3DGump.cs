...
/* Scripts/Gumps/Properties/SetPoint3DGump.cs
 * Changelog:
 *  11/17,06, Adam
 *      Add: #pragma warning disable 429
 *      The Unreachable code complaints in this file are acceptable
 *      C:\Program Files\RunUO\Scripts\Gumps\Properties\SetPoint3DGump.cs(101,68): warning CS0429: Unreachable expression code detected
 *  6/5/04, Pix
        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (p != null)
                {
                    try
                    {
                        Server.Commands.CommandLogging.LogChangeProperty(m_Mobile, m_Object, m_Property.Name, new Point3D(p).ToString());
