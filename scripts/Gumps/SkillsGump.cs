...
/* Scripts/Gumps/SkillsGump.cs
 * Changelog:
 *  11/18,06, Adam
 *      Add: #pragma warning disable 429
 *      The Unreachable code complaint in this file is acceptable
 *      C:\Program Files\RunUO\Scripts\Gumps\SkillsGump.cs(125,68): warning CS0429: Unreachable expression code detected
 */
...
namespace Server.Scripts.Gumps
{
    ...
    public class SkillsGump : Gump
    {
        ...
        //public static bool OldStyle = true;
