 ...
 * ChangeLog:
 *  3/14/2024, Adam (Engines.SoundEffect)
 *      Add support for extended sounds: Engines.SoundEffect
 *  2/16/2024, Adam
 *      add [CopyableAttribute(CopyType.DoNotCopy)] to all the properties that overwrite the same underlying value
 *      Add access property to that variable for CopyProperty.
 *  6/5/04, Pix
...
namespace Server.Items
{
    ...
    public class EffectController : Item
    {
        ...
        private Engines.SoundEffect m_SoundExID;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public Engines.SoundEffect SoundExID { get { return m_SoundExID; } set { m_SoundExID = value; } }
            ...
            : base(0x1B72)
        {
            ...
            m_SoundExID = Engines.SoundEffect.None;
        }
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            // version 1
            writer.WriteEncodedInt((int)m_SoundExID);
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                case 1:
                    {
                        m_SoundExID = (Engines.SoundEffect)reader.ReadEncodedInt();
                        goto case 0;
                    }
                case 0:
                    {
        ...
        public void PlaySoundEx(object trigger)
        {
            IEntity ent = null;
            ...
            Engines.PlaySoundEffect.Play(ent, m_SoundExID);
        }
        ...
        public void DoEffect(object trigger)
        {
            ...
            if (m_SoundExID != Engines.SoundEffect.None)
                Timer.DelayCall(m_SoundDelay, new TimerStateCallback(PlaySoundEx), trigger);
