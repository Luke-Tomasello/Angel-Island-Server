...
{
    public class OrderShield : BaseShield, IAlignmentItem
    {
        #region Alignment

        AlignmentType IAlignmentItem.GuildAlignment
        {
            get { return AlignmentType.Order; }
        }
        ...
        public bool Validate(Mobile m)
        {
            ...
            if (g == null || g.Type != GuildType.Order)
            {
                ...
                {
                    m.SendMessage("Sign up with a guild of order if thou art interested in equipping this shield.");
                }
