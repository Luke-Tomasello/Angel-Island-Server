...
/* Scripts\Items\Addons\DisplayCaseMediumAddon.cs
 * CHANGELOG:
 *  2/5/2024, Adam
...
{
    public class DisplayCaseMediumAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new DisplayCaseMediumAddonDeed();
            }
        }
        [Constructable]
        public DisplayCaseMediumAddon(int type)
        {
            switch (type)
            {
                case 0: // south
        ...
        [Constructable]
        public DisplayCaseMediumAddon()
            : this(0)
        {

        }
        public DisplayCaseMediumAddon(Serial serial)
            : base(serial)
        {
        }
    ...
    public class DisplayCaseMediumAddonDeed : BaseChoiceAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new DisplayCaseMediumAddon(m_Type);
            }
        }
        public override string DefaultName { get { return "a medium display case deed"; } }
        ...
        [Constructable]
        public DisplayCaseMediumAddonDeed()
        {

        }

        public DisplayCaseMediumAddonDeed(Serial serial)
            : base(serial)
        {
        }
