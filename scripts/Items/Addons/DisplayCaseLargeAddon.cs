...
/* Scripts\Items\Addons\DisplayCaseLargeAddon.cs
 * CHANGELOG:
 *  2/5/2024, Adam
...
{
    public class DisplayCaseLargeAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new DisplayCaseLargeAddonDeed();
            }
        }

        [Constructable]
        public DisplayCaseLargeAddon(int type)
        {
            switch (type)
            {
                case 0: // south
        ...
        [Constructable]
        public DisplayCaseLargeAddon()
            : this(0)
        {

        }
        public DisplayCaseLargeAddon(Serial serial)
            : base(serial)
        {
        }
    ...
    public class DisplayCaseLargeAddonDeed : BaseChoiceAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new DisplayCaseLargeAddon(m_Type);
            }
        }
        public override string DefaultName { get { return "a large display case deed"; } }
        ...
        [Constructable]
        public DisplayCaseLargeAddonDeed()
        {

        }

        public DisplayCaseLargeAddonDeed(Serial serial)
            : base(serial)
        {
        }
