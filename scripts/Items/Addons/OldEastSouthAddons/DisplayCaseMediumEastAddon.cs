...
namespace Server.Items
{
    public class DisplayCaseMediumEastAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new DisplayCaseMediumEastAddonDeed();
            }
        }
        ...
        public DisplayCaseMediumEastAddon(Serial serial)
            : base(serial)
        {
        }
    ...
    public class DisplayCaseMediumEastAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new DisplayCaseMediumEastAddon();
            }
        }
        ...
        {
            Name = "medium display case (east)";
        }

        public DisplayCaseMediumEastAddonDeed(Serial serial)
            : base(serial)
        {
        }
