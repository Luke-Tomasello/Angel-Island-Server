...
{
    public class TeleporterBoatEastAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new TeleporterBoatEastAddonDeed();
            }
        }

        [Constructable]
        public TeleporterBoatEastAddon()
        {
        ...
        public TeleporterBoatEastAddon(Serial serial)
            : base(serial)
        {
        }
    ...
    public class TeleporterBoatEastAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new TeleporterBoatEastAddon();
            }
        }

        [Constructable]
        public TeleporterBoatEastAddonDeed()
        {
            Name = "TeleporterBoatEast";
        }

        public TeleporterBoatEastAddonDeed(Serial serial)
            : base(serial)
        {
        }
