...
{
    public class OccloMediumEastAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new OccloMediumEastAddonDeed();
            }
        }
        ...
        public OccloMediumEastAddon(Serial serial)
            : base(serial)
        {
        }
    ...
    public class OccloMediumEastAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new OccloMediumEastAddon();
            }
        }

        [Constructable]
        public OccloMediumEastAddonDeed()
        {
            Name = "Occlo Medium Carpet [East]";
        }

        public OccloMediumEastAddonDeed(Serial serial)
            : base(serial)
        {
        }
