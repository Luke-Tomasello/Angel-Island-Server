...
{
    public class BritainLargeAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new BritainLargeAddonDeed();
            }
        }
        ...
        public BritainLargeAddon(Serial serial)
            : base(serial)
        {
        }
    ...
    public class BritainLargeAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new BritainLargeAddon();
            }
        }

        [Constructable]
        public BritainLargeAddonDeed()
        {
            Name = "Britain Large Carpet";
        }

        public BritainLargeAddonDeed(Serial serial)
            : base(serial)
        {
        }
