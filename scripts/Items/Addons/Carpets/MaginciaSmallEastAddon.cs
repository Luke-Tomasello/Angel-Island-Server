...
{
    public class MaginciaSmallEastAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new MaginciaSmallEastAddonDeed();
            }
        }
        ...
        public MaginciaSmallEastAddon(Serial serial)
            : base(serial)
        {
        }
    ...
    public class MaginciaSmallEastAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new MaginciaSmallEastAddon();
            }
        }

        [Constructable]
        public MaginciaSmallEastAddonDeed()
        {
            Name = "Magincia Small Carpet [East]";
        }

        public MaginciaSmallEastAddonDeed(Serial serial)
            : base(serial)
        {
        }
