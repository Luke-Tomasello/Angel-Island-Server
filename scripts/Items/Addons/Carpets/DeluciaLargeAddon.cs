...
{
    public class DeluciaLargeAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new DeluciaLargeAddonDeed();
            }
        }
        ...
        public DeluciaLargeAddon(Serial serial)
            : base(serial)
        {
        }
    ...
    public class DeluciaLargeAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new DeluciaLargeAddon();
            }
        }

        [Constructable]
        public DeluciaLargeAddonDeed()
        {
            Name = "Delucia Large Carpet";
        }

        public DeluciaLargeAddonDeed(Serial serial)
            : base(serial)
        {
        }
