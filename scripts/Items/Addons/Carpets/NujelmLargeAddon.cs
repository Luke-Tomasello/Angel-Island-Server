...
{
    public class NujelmLargeAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new NujelmLargeAddonDeed();
            }
        }
        ...
        public NujelmLargeAddon(Serial serial)
            : base(serial)
        {
        }
    ...
    public class NujelmLargeAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new NujelmLargeAddon();
            }
        }

        [Constructable]
        public NujelmLargeAddonDeed()
        {
            Name = "Nujelm Large Carpet";
        }

        public NujelmLargeAddonDeed(Serial serial)
            : base(serial)
        {
        }
