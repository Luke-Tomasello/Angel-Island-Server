...
{
    public class MinocMediumSouthAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                return new MinocMediumSouthAddonDeed();
            }
        }
        ...
        public MinocMediumSouthAddon(Serial serial)
            : base(serial)
        {
        }
    ...
    public class MinocMediumSouthAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new MinocMediumSouthAddon();
            }
        }

        [Constructable]
        public MinocMediumSouthAddonDeed()
        {
            Name = "Minoc Medium Carpet [South]";
        }

        public MinocMediumSouthAddonDeed(Serial serial)
            : base(serial)
        {
        }
