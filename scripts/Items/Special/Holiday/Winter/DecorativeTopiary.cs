...
/* Scripts/Items/Special/Holiday/Winter/DecorativeTopiary.cs
 * Changelog:
 *	11/27/21, Yoar
 *		Initial version.
 */
...
{
    public class DecorativeTopiary : Item, IHolidayItem
    {
        private int m_Year;
        ...
        [Constructable]
        public DecorativeTopiary(int year) : base(0x2378)
        {
            Weight = 1.0;
            m_Year = year;
        }
