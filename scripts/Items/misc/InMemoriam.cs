...
{
    [FlipableAttribute(0xEDB, 0xEDC)]
    public class InMemoriam : Item
    {
        [Constructable]
        public InMemoriam()
            : base(0xEDC)
        ...
        public InMemoriam(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            LabelTo(from, "In Memoriam");
            LabelTo(from, Name);
            LabelTo(from, "Rest in peace");
            LabelTo(from, Created.ToString("MMM, yyyy"));
        }
