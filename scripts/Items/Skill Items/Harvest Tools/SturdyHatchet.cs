...
namespace Server.Items
{
    ...
    public class SturdyHatchet : BaseAxe
    {
        public override string DefaultName { get { return "sturdy hatchet"; } }
        ...
        [Constructable]
        public SturdyHatchet()
            : this(180)
        {
        }

        [Constructable]
        public SturdyHatchet(int uses)
            : base(0xF43)
        {
            Weight = 4.0;
            Hue = 0x973;
        ...
        public SturdyHatchet(Serial serial)
            : base(serial)
        {
        }
