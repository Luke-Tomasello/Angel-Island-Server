 ...
 * CHANGELOG:
 *	11/29/21, Adam: 
 *	    Complaint: LOS checks don't match that of the pickaxe (ProspectorsTool doesn't see spots than can be mined.)
 *	    changed to match Harvest Target (CheckLOS = false;)
 */
    ...
    public class ProspectorsTool : BaseBashing, IUsesRemaining
    {
        ...
        private class InternalTarget : Target
        {
                ...
                : base(2, true, TargetFlags.None)
            {
                ...
                // 11/29/21, Adam: changed to match Harvest Target
                CheckLOS = false;
            }
