 ...
 *  7/7/23, Yoar
 *      Replaced rum stained/blood stained SOS with ancient SOS
 *      Old rum stained/blood stained SOS will become grandfathered items
 *	9/3/10, Adam
 *		Old school SOS messages
...
namespace Server.Items
{
    public class SOS : Item
    {
        ...
        public override int LabelNumber
        {
            get { return 1041081; } // a waterstained SOS
        }
        ...
        public override string DefaultName
        {
            ...
            {
                if (m_level == 5)
                    return "a bloodstained SOS";
                else if (m_level == 4)
                    return "a rumstained SOS";
                else
...
#if false
            if (IsAncient)
                Hue = FabledFishingNet.FabledHue;
#else
            if (m_level == 5)
                Hue = 0x670;
            else if (m_level == 4)
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (IsAncient && (Hue == 0x481 || Hue == 0x4CD || Hue == FabledFishingNet.FabledHue))
                UpdateHue();
        }
        ...
        private class MessageGump : Gump
        {
                ...
                : base(150, 50)
            {
                ...
                AddHtml(30, 80, 285, 160, string.Format(entry.Message, fmt), true, true);
