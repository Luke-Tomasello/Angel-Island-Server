...
{
    public class RevelationWaveSpell : Spell
    {
        private static SpellInfo m_Info = new SpellInfo(
                "Revelation Wave", "Ara Wis Quas",
                SpellCircle.Third,
                230,
                9052,
                false,
        ...
        public RevelationWaveSpell(Mobile caster, Item scroll)
        ...
        private void DoVisualForPlayer(Mobile m)
        {
