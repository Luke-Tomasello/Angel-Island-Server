...
namespace Server.Multis
{
    public class ComponentVerification
    {
        ...
        public ComponentVerification()
        {
            ...
            LoadItems(Path.Combine(Core.DataDirectory, "Components", "walls.txt"), "South1", "South2", "South3", "Corner", "East1", "East2", "East3", "Post", "WindowS", "AltWindowS", "WindowE", "AltWindowE", "SecondAltWindowS", "SecondAltWindowE");
            LoadItems(Path.Combine(Core.DataDirectory, "Components", "teleprts.txt"), "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12", "F13", "F14", "F15", "F16");
            LoadItems(Path.Combine(Core.DataDirectory, "Components", "stairs.txt"), "Block", "North", "East", "South", "West", "Squared1", "Squared2", "Rounded1", "Rounded2");
            LoadItems(Path.Combine(Core.DataDirectory, "Components", "roof.txt"), "North", "East", "South", "West", "NSCrosspiece", "EWCrosspiece", "NDent", "EDent", "SDent", "WDent", "NTPiece", "ETPiece", "STPiece", "WTPiece", "XPiece", "Extra Piece");
            LoadItems(Path.Combine(Core.DataDirectory, "Components", "floors.txt"), "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12", "F13", "F14", "F15", "F16");
            LoadItems(Path.Combine(Core.DataDirectory, "Components", "misc.txt"), "Piece1", "Piece2", "Piece3", "Piece4", "Piece5", "Piece6", "Piece7", "Piece8");
            LoadItems(Path.Combine(Core.DataDirectory, "Components", "doors.txt"), "Piece1", "Piece2", "Piece3", "Piece4", "Piece5", "Piece6", "Piece7", "Piece8");

            LoadMultis(Path.Combine(Core.DataDirectory, "Components", "stairs.txt"), "MultiNorth", "MultiEast", "MultiSouth", "MultiWest");
        }
