    ...
    public class SBBootlegger : SBInfo
    {
        ...
        public class InternalBuyInfo : ArrayList
        {
            public InternalBuyInfo()
            {
                ...
                {
                    Add(new GenericBuyInfo(typeof(MandrakeRoot), BaseVendor.PlayerPays(typeof(MandrakeRoot)), 500, 500, 999, 0xF86, 0));
                    Add(new GenericBuyInfo(typeof(SulfurousAsh), BaseVendor.PlayerPays(typeof(SulfurousAsh)), 500, 500, 999, 0xF8C, 0));
                }
            }
        }
