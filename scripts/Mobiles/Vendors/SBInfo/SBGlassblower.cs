...
namespace Server.Mobiles
{
    public class SBGlassblower : SBInfo
    {
        ...
        public class InternalBuyInfo : ArrayList
        {
            ...
            {
                Add(new GenericBuyInfo("Crafting Glass With Glassblowing", typeof(GlassblowingBook), BaseVendor.PlayerPays(typeof(GlassblowingBook)), 30, 0xFF4, 0));
                Add(new GenericBuyInfo("Finding Glass-Quality Sand", typeof(SandMiningBook), BaseVendor.PlayerPays(typeof(SandMiningBook)), 30, 0xFF4, 0));
                Add(new GenericBuyInfo("1044608", typeof(Blowpipe), BaseVendor.PlayerPays(typeof(Blowpipe)), 100, 0xE8A, 0x3B9));
            }
        }
        ...
        public class InternalSellInfo : GenericSellInfo
        {
            public InternalSellInfo()
            {
                ...
                {   // cash buyback
                    Add(typeof(GlassblowingBook), BaseVendor.VendorPays(typeof(GlassblowingBook)));
                    Add(typeof(SandMiningBook), BaseVendor.VendorPays(typeof(SandMiningBook)));
                    Add(typeof(Blowpipe), BaseVendor.VendorPays(typeof(Blowpipe)));
                }
            }
        }
    }
