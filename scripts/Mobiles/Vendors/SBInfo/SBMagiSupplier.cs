    ...
    public class SBMagiSupplier : SBInfo
    {
        ...
        public class InternalBuyInfo : ArrayList
        {
            public InternalBuyInfo()
            {
                ...
                {
                    Add(new GenericBuyInfo("Arms of the Bone Magi", typeof(BoneMagiArms), BaseVendor.PlayerPays(typeof(BoneMagiArms)), 20, 0x144E, 0));
                    Add(new GenericBuyInfo("Armor of the Bone Magi", typeof(BoneMagiArmor), BaseVendor.PlayerPays(typeof(BoneMagiArmor)), 20, 0x144F, 0));
                    Add(new GenericBuyInfo("Gloves of the Bone Magi", typeof(BoneMagiGloves), BaseVendor.PlayerPays(typeof(BoneMagiGloves)), 20, 0x1450, 0));
                    Add(new GenericBuyInfo("Legs of the Bone Magi", typeof(BoneMagiLegs), BaseVendor.PlayerPays(typeof(BoneMagiLegs)), 20, 0x1452, 0));
                    Add(new GenericBuyInfo("Helm of the Bone Magi", typeof(BoneMagiHelm), BaseVendor.PlayerPays(typeof(BoneMagiHelm)), 20, 0x1451, 0));
                }
            }
        }
