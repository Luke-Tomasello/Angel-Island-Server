    ...
    public class SBSmuggler : SBInfo
    {
        ...
        public class InternalBuyInfo : ArrayList
        {
            public InternalBuyInfo()
            {
                ...
                {
                    Add(new GenericBuyInfo(typeof(GrapplingHook), BaseVendor.PlayerPays(typeof(GrapplingHook)), 10, 10, 30, 0x14F8, 0));
                    Add(new GenericBuyInfo(typeof(BlackPearl), BaseVendor.PlayerPays(typeof(BlackPearl)), 500, 500, 999, 0xF7A, 0));
                    Add(new GenericBuyInfo(typeof(SpidersSilk), BaseVendor.PlayerPays(typeof(SpidersSilk)), 500, 500, 999, 0xF8D, 0));
                }
            }
        }
