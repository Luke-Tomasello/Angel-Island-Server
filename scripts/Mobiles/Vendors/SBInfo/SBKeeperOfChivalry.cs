...
/* Scripts/Mobiles/Vendors/SBInfo/SBKeeperOfChivalry.cs
 * ChangeLog
...
namespace Server.Mobiles
{
    public class SBKeeperOfChivalry : SBInfo
    {
        ...
        public class InternalBuyInfo : ArrayList
        {
            ...
            {
                Add(new GenericBuyInfo(typeof(BookOfChivalry), BaseVendor.PlayerPays(typeof(BookOfChivalry)), 20, 0x2252, 0));
            }
        }
        ...
        public class InternalSellInfo : GenericSellInfo
        {
            ...
            {
                Add(typeof(BookOfChivalry), BaseVendor.VendorPays(typeof(BookOfChivalry)));
            }
        }
    }
}