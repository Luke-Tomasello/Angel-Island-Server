...
namespace Server.Mobiles
{
    public class SBHairStylist : SBInfo
    {
        ...
        public class InternalBuyInfo : ArrayList
        {
            ...
            {
                Add(new GenericBuyInfo("special beard dye", typeof(SpecialBeardDye), BaseVendor.PlayerPays(typeof(SpecialBeardDye)), 20, 0xE26, 0));
                Add(new GenericBuyInfo("special hair dye", typeof(SpecialHairDye), BaseVendor.PlayerPays(typeof(SpecialHairDye)), 20, 0xE26, 0));
        ...
        public class InternalSellInfo : GenericSellInfo
        {
            public InternalSellInfo()
            {
                ...
                {   // cash buyback
                    ...
                    Add(typeof(SpecialBeardDye), BaseVendor.VendorPays(typeof(SpecialBeardDye)));
                    Add(typeof(SpecialHairDye), BaseVendor.VendorPays(typeof(SpecialHairDye)));
                }
            }
        }
    }
