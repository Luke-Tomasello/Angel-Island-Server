 ...
 *	11/30/21, Yoar
 *	    Added FishingScales to BuyInfo.
 *	4/24/04, mith
...
namespace Server.Mobiles
{
    public class SBFisherman : SBInfo
    {
        ...
        public class InternalBuyInfo : ArrayList
        {
            ...
            {
                Add(new GenericBuyInfo(typeof(RawFishSteak), BaseVendor.PlayerPays(typeof(RawFishSteak)), 20, 0x97A, 0));
                Add(new GenericBuyInfo(typeof(Fish), BaseVendor.PlayerPays(typeof(Fish)), 80, 0x9CC, 0));
                Add(new GenericBuyInfo(typeof(FishingPole), BaseVendor.PlayerPays(typeof(FishingPole)), 20, 0xDC0, 0));

                // 7/26/23, Yoar: Enabled for all shards
                if (/*Core.RuleSets.AngelIslandRules()*/true)
                    Add(new GenericBuyInfo("Fishing Scales", typeof(FishingScales), BaseVendor.PlayerPays(typeof(FishingScales)), 20, 0x1852, 0));
            }
        }
        ...
        public class InternalSellInfo : GenericSellInfo
        {
            public InternalSellInfo()
            {
                ...
                {   // cash buyback
                    Add(typeof(RawFishSteak), BaseVendor.VendorPays(typeof(RawFishSteak)));
                    Add(typeof(Fish), BaseVendor.VendorPays(typeof(Fish)));
                    Add(typeof(FishingPole), BaseVendor.VendorPays(typeof(FishingPole)));
                }
            }
        }
    }
