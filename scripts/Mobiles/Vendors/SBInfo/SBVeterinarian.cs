...
namespace Server.Mobiles
{
    public class SBVeterinarian : SBInfo
    {
        ...
        public class InternalBuyInfo : ArrayList
        {
            ...
            {
                Add(new AnimalBuyInfo(1, typeof(Cat), BaseVendor.PlayerPays(typeof(Cat)), 10, 0x211B, 0));
                Add(new AnimalBuyInfo(1, typeof(Dog), BaseVendor.PlayerPays(typeof(Dog)), 10, 0x211C, 0));
                Add(new AnimalBuyInfo(1, typeof(PackHorse), BaseVendor.PlayerPays(typeof(PackHorse)), 10, 0x2126, 0));
                Add(new AnimalBuyInfo(1, typeof(PackLlama), BaseVendor.PlayerPays(typeof(PackLlama)), 10, 0x2127, 0));
