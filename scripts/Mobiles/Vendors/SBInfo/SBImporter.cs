...
namespace Server.Mobiles
{
    public class SBImporter : SBInfo
    {
        ...
        public class InternalBuyInfo : ArrayList
        {
            ...
            {
                Add(new GenericBuyInfo(typeof(Bloodmoss), BaseVendor.PlayerPays(typeof(Bloodmoss)), 500, 500, 999, 0xF7B, 0));
                Add(new GenericBuyInfo(typeof(Garlic), BaseVendor.PlayerPays(typeof(Garlic)), 500, 500, 999, 0xF84, 0));
            }
        }
