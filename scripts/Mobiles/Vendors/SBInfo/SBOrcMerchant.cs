...
/* Scripts/Mobiles/Vendors/SBInfo/SBOrcMerchant.cs
 * ChangeLog
...
{
    public class SBOrcMerchant : SBInfo
    {
        private ArrayList m_BuyInfo = new InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new InternalSellInfo();

        public SBOrcMerchant()
        {
        }
        ...
        public class InternalBuyInfo : ArrayList
        {
            public InternalBuyInfo()
            {
                ...
                {
                    Add(new GenericBuyInfo(typeof(Bottle), BaseVendor.PlayerPays(typeof(Bottle)), 500, 500, 999, 0xF0E, 0));
                    Add(new GenericBuyInfo(typeof(BlankScroll), BaseVendor.PlayerPays(typeof(BlankScroll)), 500, 500, 999, 0x0E34, 0));
                }
            }
        }
