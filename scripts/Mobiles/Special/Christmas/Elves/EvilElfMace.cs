...
/* Scripts\Mobiles\Special\Christmas Elves\EvilElfMace.cs
 * ChangeLog
 * 12/12/23, Yoar
...
namespace Server.Mobiles
{
    ...
    public class EvilElfMace : BaseChristmasElf
    {
        [Constructable]
        public EvilElfMace()
            : base(AIType.AI_HumanMelee, FightMode.All | FightMode.Closest, 16, 1, 0.1, 0.25)
        {
        ...
        public EvilElfMace(Serial serial)
            : base(serial)
        {
        }
