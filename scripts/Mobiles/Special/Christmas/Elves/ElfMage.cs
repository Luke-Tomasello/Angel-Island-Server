...
/* Scripts\Mobiles\Special\Christmas Elves\ElfMage.cs
 * ChangeLog
 * 12/12/23, Yoar
...
namespace Server.Mobiles
{
    ...
    public class ElfMage : BaseChristmasElf
    {
        [Constructable]
        public ElfMage()
            : base(Core.RuleSets.AngelIslandRules() ? AIType.AI_BaseHybrid : AIType.AI_Mage, FightMode.Aggressor | FightMode.Closest, 16, 1, 0.1, 0.25)
        {
